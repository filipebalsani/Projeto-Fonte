...
![Circuito_Grafico_1](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/Circuito_Grafico_1.png "Voltagem filtrada pelo Capacitor")
...
:------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------:
![](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/Fonte_de_Tensao.png "Tomada")|![](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/Onda_1.png "Gráfico da Voltagem")
+ #### Transformador
...
:------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------:
![](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/Onda_1.png "Gráfico da Voltagem")|![](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/Onda_2.png "Gráfico da Voltagem")
+ #### Diodo
...
:------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------:
![](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/Onda_2.png "Gráfico da Voltagem")|![](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/Onda_3.png "Gráfico da Voltagem")
...
:------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------:
![](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/Onda_3.png "Gráfico da Voltagem")|![](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/Onda_4.png "Gráfico da Voltagem")

|Os dois gráficos sobrepostos                                                                  |
|:--------------------------------------------------------------------------------------------:|
|![](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/Onda_5.png "Gráfico da Voltagem")|
+ #### Resistor
...
:------------------------------------------------------------------------------------------:|
![](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/Circuito_Grafico_2.png "Tensão e Corrente Final")|
+ #### Potenciômetro
...
:------------------------------------------------------------------------------------------:|
![](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/Circuito_Grafico_3.png "Tensão e Corrente Final")|
+ #### Transistor Bipolar NPN
O transistor permite a passagem de corrente de forma ajustável.
## Circuito no EAGLE
![](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/EAGLE_Circuito.png "Circuito no EAGLE")
## PCB no EAGLE
![](https://github.com/filipebalsani/Projeto-Fonte/blob/main/Imagens/EAGLE_Board.png "PCB no EAGLE")
